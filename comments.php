...
<ul class="comment-form">
	<li>
		...
		<label for="author">Name <span class='<?php if ($req) echo 'required'; ?>'><?php if ($req) echo '(required)'; ?></span></label>
	</li>
	
	<li>
		<input type="text" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="22" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> />
		<label for="email">Mail (will not be published) <span class='<?php if ($req) echo 'required'; ?>'><?php if ($req) echo '(required)'; ?></span></label>
	</li>
